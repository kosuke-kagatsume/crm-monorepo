...
export const roleConfig: Record<Role, { widgets: WidgetId[] }> = {
  ...
  sales: {
    widgets: ['estimateActions', 'alerts', 'todo', 'projectsSnap', 'ragToggle'],
  },
  accounting: {
    widgets: ['kpi', 'estimateActions', 'accountingPanel', 'ragToggle'],
  },
  marketing: {
    widgets: ['kpi', 'estimateActions', 'marketingPanel', 'ragToggle'],
  },
  foreman: {
